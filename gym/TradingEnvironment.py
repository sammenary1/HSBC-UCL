...
class TradingEnvironment(gym.Env):
    ...
    def __init__(
        ...
        start_time: Union[int, Tuple[float, float]] = 0,  # Either a deterministic initial inventory, or a tuple
    ...
    def _get_start_time(self):
        ...
        elif isinstance(self.start_time, tuple) and len(self.start_time) == 2:
            random_start = self.rng.uniform(self.start_time[0], self.start_time[1])
